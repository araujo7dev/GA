...
<body>
    ...
    <div class="container w-auto text-dark bg-white border border-dark p-1 rounded" style="box-shadow: 2px 2px 25px black;">
        ...
        <?php
            ...
            $queryContrato = $pdo->query( "SELECT 
                                                locatario.nome, 
                                                imoveis.utilizacao, 
                                                imoveis.designacao,
                                                contratos.valor,
        ...
        <div class="container">
          ...
          <fieldset>
            ...
            <?php 
                    $verificaMensalidades = $pdo->query("SELECT 
                                                                m.id,
                                                                m.data_vencto,
                                                                m.valor,
                                                                m.status,
                                                                ...
                                                                WHERE c.id='$idContrato'
                                                                        ");
                    $mensalidade = $verificaMensalidades->fetch();
                        ...
                        <div class="container w-auto mt-2">
                            <table class="table  table-responsive table-hover table-bordered border border-dark p-4">
                                ...
                                <?php 
                                    ...
                                    $listaMensalidades = $pdo->query( "SELECT 
                                                                locat.nome,
                                                                mens.valor,
